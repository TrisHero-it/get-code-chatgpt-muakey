            ...
            ?>
                ...
                ?>
                    <tr>
                        ...
                        <td><strong><?php echo htmlspecialchars($order['code'] ?? 'N/A') ?></strong></td>
                        <td><?php echo htmlspecialchars($order['product_id'] ?? 'N/A') ?></td>
                        <td><span class="badge bg-<?php echo $statusClass ?>"><?php echo $statusText ?></span></td>
                        <td><?php echo isset($order['sale_agent_id']) && $order['sale_agent_id'] !== null && $order['sale_agent_id'] !== '' ? (int)$order['sale_agent_id'] : '—' ?></td>
